...
[![Go Report Card](https://goreportcard.com/badge/github.com/hierarchicall/iotwifi)](https://goreportcard.com/report/github.com/hierarchicall/iotwifi)
[![GoDoc](https://godoc.org/github.com/hierarchicall/iotwifi/iotwifi?status.svg)](https://godoc.org/github.com/hierarchicall/iotwifi/iotwifi)
[![Docker Container Image Size](https://shields.beevelop.com/docker/image/image-size/hierarchicall/iotwifi/latest.svg)](https://hub.docker.com/r/hierarchicall/iotwifi/)
[![Docker Container Layers](https://shields.beevelop.com/docker/image/layers/hierarchicall/iotwifi/latest.svg)](https://hub.docker.com/r/hierarchicall/iotwifi/)
[![Docker Container Pulls](https://img.shields.io/docker/pulls/hierarchicall/iotwifi.svg)](https://hub.docker.com/r/hierarchicall/iotwifi/)

[![Waffle.io - Columns and their card count](https://badge.waffle.io/hierarchicall/iotwifi.svg?columns=all)](https://waffle.io/hierarchicall/iotwifi)
...
intended to run in a [Docker container on a Raspberry Pi](https://hub.docker.com/r/hierarchicall/iotwifi/).
...
the source is found in this repository: https://github.com/hierarchicall/iotwifi.

```bash
# Pull the IOT Wifi Docker Image
$ docker pull hierarchicall/iotwifi
```
...
$ wget https://raw.githubusercontent.com/hierarchicall/iotwifi/master/cfg/wificfg.json
...
the **[hierarchicall/iotwifi]** Docker image we pulled in the steps above. The container needs to run in a **privileged mode** and have access to the **host network** (the
...
> You can use my simple static web server IOT Web container for hosting a Captive Portal or configuration web page. See https://github.com/hierarchicall/iotweb.
...
Check out the project [IOT Web](https://github.com/hierarchicall/iotweb) to get
...
[hierarchicall/iotwifi]: https://hub.docker.com/r/hierarchicall/iotwifi/
