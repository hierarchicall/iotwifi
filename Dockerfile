...
RUN mkdir -p /go/src/github.com/hierarchicall/iotwifi
COPY . /go/src/github.com/hierarchicall/iotwifi

RUN CGO_ENABLED=0 go build -a -installsuffix cgo -o /go/bin/wifi /go/src/github.com/hierarchicall/iotwifi/main.go
